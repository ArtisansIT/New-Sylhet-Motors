...
<head>
  ...
  <!-- Morris chart -->
  <link rel="stylesheet" href="{{ asset('admin/css/bower_components/morris.js/morris.css') }}">
  <!-- jvectormap -->
  <link rel="stylesheet" href="{{ asset('admin/css/bower_components/jvectormap/jquery-jvectormap.css') }}">
  <!-- Date Picker -->
