...
<!-- jQuery UI 1.11.4 -->
<script src="{{ asset('admin/css/bower_components/jquery-ui/jquery-ui.min.js') }}"></script>
...
<!-- Morris.js charts -->
<script src="{{ asset('admin/css/bower_components/raphael/raphael.min.js') }}"></script>
<script src="{{ asset('admin/css/bower_components/morris.js/morris.min.js') }}"></script>
<!-- Sparkline -->
<script src="{{ asset('admin/css/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js') }}"></script>
<!-- jvectormap -->
...
<!-- jQuery Knob Chart -->
<script src="{{ asset('admin/css/bower_components/jquery-knob/dist/jquery.knob.min.js') }}"></script>
<!-- daterangepicker -->
