                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3 d-block d-lg-none">
                            <div class="header-logo_area header-sticky_logo">
                                <a href="index.html">
                                    <img src="{{ asset('frontend/assets/images/menu/logo/1.png')}}" alt="Uren's Logo">
                                </a>
                            </div>
                        </div>
                        ...
                        <ul class="minicart-list">
                            <li class="minicart-product">
                                ...
                                <div class="product-item_img">
                                    <img src="{{ asset('frontend/assets/images/product/small-size/1.jpg')}}" alt="Uren's Product Image">
                                </div>
                            ...
                            <li class="minicart-product">
                                <a class="product-item_remove" href="javascript:void(0)"><i
                                    class="ion-android-close"></i></a>
                                <div class="product-item_img">
                                    <img src="{{ asset('frontend/assets/images/product/small-size/2.jpg')}}" alt="Uren's Product Image">
                                </div>
                                <div class="product-item_content">
                            ...
                            <li class="minicart-product">
                                <a class="product-item_remove" href="javascript:void(0)"><i
                                    class="ion-android-close"></i></a>
                                <div class="product-item_img">
                                    <img src="{{ asset('frontend/assets/images/product/small-size/3.jpg')}}" alt="Uren's Product Image">
                                </div>
                                <div class="product-item_content">
                        ...
                        "arrows" : true
                            ...
                            <div class="slide-item">
                                <div class="slide-inner">
                                    <div class="slide-image_area">
                                        <a href="shop-left-sidebar.html">
                                            <img src="{{ asset('frontend/assets/images/featured-categories/1.png')}}" alt="Uren's Featured Categories">
                                        </a>
                                    </div>
                            ...
                            <div class="slide-item">
                                <div class="slide-inner">
                                    <div class="slide-image_area">
                                        <a href="shop-left-sidebar.html">
                                            <img src="{{ asset('frontend/assets/images/featured-categories/2.png')}}" alt="Uren's Featured Categories">
                                        </a>
                                    </div>
                                    <div class="slide-content_area">
                            ...
                            <div class="slide-item">
                                <div class="slide-inner">
                                    <div class="slide-image_area">
                                        <a href="shop-left-sidebar.html">
                                            <img src="{{ asset('frontend/assets/images/featured-categories/3.png')}}" alt="Uren's Featured Categories">
                                        </a>
                                    </div>
                                    <div class="slide-content_area">
                            ...
                            <div class="slide-item">
                                <div class="slide-inner">
                                    <div class="slide-image_area">
                                        <a href="shop-left-sidebar.html">
                                            <img src="{{ asset('frontend/assets/images/featured-categories/4.png')}}" alt="Uren's Featured Categories">
                                        </a>
                                    </div>
                                    <div class="slide-content_area">
                            ...
                            <div class="slide-item">
                                <div class="slide-inner">
                                    <div class="slide-image_area">
                                        <a href="shop-left-sidebar.html">
                                            <img src="{{ asset('frontend/assets/images/featured-categories/5.png')}}" alt="Uren's Featured Categories">
                                        </a>
                                    </div>
                                    <div class="slide-content_area">
                            ...
                            <div class="slide-item">
                                <div class="slide-inner">
                                    <div class="slide-image_area">
                                        <a href="shop-left-sidebar.html">
                                            <img src="{{ asset('frontend/assets/images/featured-categories/6.png')}}" alt="Uren's Featured Categories">
                                        </a>
                                    </div>
                                    <div class="slide-content_area">
                                ...
                                <div class="inner-slide">
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="single-product.html">
                                                <img class="primary-img" src="{{ asset('frontend/assets/images/product/medium-size/1-1.jpg')}}" alt="Uren's Product Image">
                                                <img class="secondary-img" src="{{ asset('frontend/assets/images/product/medium-size/1-2.jpg')}}" alt="Uren's Product Image">
                                            </a>
                                            <div class="sticker">
                            ...
                            <div class="product-slide_item">
                                <div class="inner-slide">
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="single-product.html">
                                                <img class="primary-img" src="{{ asset('frontend/assets/images/product/medium-size/2-1.jpg')}}" alt="Uren's Product Image">
                                                <img class="secondary-img" src="{{ asset('frontend/assets/images/product/medium-size/2-2.jpg')}}" alt="Uren's Product Image">
                                            </a>
                            ...
                            <div class="product-slide_item">
                                <div class="inner-slide">
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="single-product.html">
                                                <img class="primary-img" src="{{ asset('frontend/assets/images/product/medium-size/3-1.jpg')}}" alt="Uren's Product Image">
                                                <img class="secondary-img" src="{{ asset('frontend/assets/images/product/medium-size/3-2.jpg')}}" alt="Uren's Product Image">
                                            </a>
                                            <span class="sticker">New</span>
                                            <div class="add-actions">
                                                <ul>
                            ...
                            <div class="product-slide_item">
                                <div class="inner-slide">
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="single-product.html">
                                                <img class="primary-img" src="{{ asset('frontend/assets/images/product/medium-size/4-1.jpg')}}" alt="Uren's Product Image">
                                                <img class="secondary-img" src="{{ asset('frontend/assets/images/product/medium-size/4-2.jpg')}}" alt="Uren's Product Image">
                                            </a>
                                            <div class="sticker-area-2">
                            ...
                            <div class="product-slide_item">
                                <div class="inner-slide">
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="single-product.html">
                                                <img class="primary-img" src="{{ asset('frontend/assets/images/product/medium-size/5-1.jpg')}}" alt="Uren's Product Image">
                                                <img class="secondary-img" src="{{ asset('frontend/assets/images/product/medium-size/5-2.jpg')}}" alt="Uren's Product Image">
                                            </a>
                                            <span class="sticker">New</span>
                                            <div class="add-actions">
                                                <ul>
                            ...
                            <div class="product-slide_item">
                                <div class="inner-slide">
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="single-product.html">
                                                <img class="primary-img" src="{{ asset('frontend/assets/images/product/medium-size/6-1.jpg')}}" alt="Uren's Product Image">
                                                <img class="secondary-img" src="{{ asset('frontend/assets/images/product/medium-size/6-2.jpg')}}" alt="Uren's Product Image">
                                            </a>
                                            <div class="sticker-area-2">
                            ...
                            <div class="product-slide_item">
                                <div class="inner-slide">
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="single-product.html">
                                                <img class="primary-img" src="{{ asset('frontend/assets/images/product/medium-size/7-1.jpg')}}" alt="Uren's Product Image">
                                                <img class="secondary-img" src="{{ asset('frontend/assets/images/product/medium-size/7-2.jpg')}}" alt="Uren's Product Image">
                                            </a>
                                            <span class="sticker">New</span>
                                            <div class="add-actions">
                                                <ul>
                            ...
                            <div class="product-slide_item">
                                <div class="inner-slide">
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="single-product.html">
                                                <img class="primary-img" src="{{ asset('frontend/assets/images/product/medium-size/8-1.jpg')}}" alt="Uren's Product Image">
                                                <img class="secondary-img" src="{{ asset('frontend/assets/images/product/medium-size/1-2.jpg')}}" alt="Uren's Product Image">
                                            </a>
                                            <span class="sticker">New</span>
                                            <div class="add-actions">
                                ...
                                <div class="inner-slide">
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="single-product.html">
                                                <img class="primary-img" src="{{ asset('frontend/assets/images/product/medium-size/1-1.jpg')}}" alt="Uren's Product Image">
                                                <img class="secondary-img" src="{{ asset('frontend/assets/images/product/medium-size/4-1.jpg')}}" alt="Uren's Product Image">
                                            </a>
                                            <div class="sticker-area-2">
                            ...
                            <div class="slide-item">
                                <div class="inner-slide">
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="single-product.html">
                                                <img class="primary-img" src="{{ asset('frontend/assets/images/product/medium-size/4-2.jpg')}}" alt="Uren's Product Image">
                                                <img class="secondary-img" src="{{ asset('frontend/assets/images/product/medium-size/5-2.jpg')}}" alt="Uren's Product Image">
                                            </a>
                                            <div class="sticker-area-2">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="banner-item img-hover_effect">
                            <a href="shop-left-sidebar.html">
                                <img class="img-full" src="{{ asset('frontend/assets/images/banner/2-3.jpg')}}" alt="Uren's Banner">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="banner-item img-hover_effect">
                            <a href="shop-left-sidebar.html">
                                <img class="img-full" src="{{ asset('frontend/assets/images/banner/2-4.jpg')}}" alt="Uren's Banner">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="banner-item img-hover_effect">
                            <a href="shop-left-sidebar.html">
                                <img class="img-full" src="{{ asset('frontend/assets/images/banner/2-5.jpg')}}" alt="Uren's Banner">
                            </a>
                        </div>
                    </div>
                </div>
                        ...
                        "slidesToShow": 6
                            ...
                            <div class="slide-item">
                                <div class="inner-slide">
                                    <div class="single-product">
                                        <a href="javascript:void(0)">
                                            <img src="{{ asset('frontend/assets/images/brand/1.jpg')}}" alt="Uren's Brand Image">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="slide-item">
                                <div class="inner-slide">
                                    <div class="single-product">
                                        <a href="javascript:void(0)">
                                            <img src="{{ asset('frontend/assets/images/brand/2.jpg')}}" alt="Uren's Brand Image">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="slide-item">
                                <div class="inner-slide">
                                    <div class="single-product">
                                        <a href="javascript:void(0)">
                                            <img src="{{ asset('frontend/assets/images/brand/3.jpg')}}" alt="Uren's Brand Image">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="slide-item">
                                <div class="inner-slide">
                                    <div class="single-product">
                                        <a href="javascript:void(0)">
                                            <img src="{{ asset('frontend/assets/images/brand/4.jpg')}}" alt="Uren's Brand Image">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="slide-item">
                                <div class="inner-slide">
                                    <div class="single-product">
                                        <a href="javascript:void(0)">
                                            <img src="{{ asset('frontend/assets/images/brand/5.jpg')}}" alt="Uren's Brand Image">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="slide-item">
                                <div class="inner-slide">
                                    <div class="single-product">
                                        <a href="javascript:void(0)">
                                            <img src="{{ asset('frontend/assets/images/brand/6.jpg')}}" alt="Uren's Brand Image">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="slide-item">
                                <div class="inner-slide">
                                    <div class="single-product">
                                        <a href="javascript:void(0)">
                                            <img src="{{ asset('frontend/assets/images/brand/7.jpg')}}" alt="Uren's Brand Image">
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        "arrows" : true
                            ...
                            <div class="slide-item">
                                <div class="inner-slide">
                                    <div class="blog-img img-hover_effect">
                                        <a href="blog-details-left-sidebar.html">
                                            <img src="{{ asset('frontend/assets/images/blog/large-size/1.jpg')}}" alt="Uren's Blog Image">
                                        </a>
                            ...
                            <div class="slide-item">
                                <div class="inner-slide">
                                    <div class="blog-img img-hover_effect">
                                        <a href="blog-details-left-sidebar.html">
                                            <img src="{{ asset('frontend/assets/images/blog/large-size/2.jpg')}}" alt="Uren's Blog Image">
                                        </a>
                            ...
                            <div class="slide-item">
                                <div class="inner-slide">
                                    <div class="blog-img img-hover_effect">
                                        <a href="blog-details-left-sidebar.html">
                                            <img src="{{ asset('frontend/assets/images/blog/large-size/3.jpg')}}" alt="Uren's Blog Image">
                                        </a>
                            ...
                            <div class="slide-item">
                                <div class="inner-slide">
                                    <div class="blog-img img-hover_effect">
                                        <a href="blog-details-left-sidebar.html">
                                            <img src="{{ asset('frontend/assets/images/blog/large-size/4.jpg')}}" alt="Uren's Blog Image">
                                        </a>
                            ...
                            <div class="slide-item">
                                <div class="inner-slide">
                                    <div class="blog-img img-hover_effect">
                                        <a href="blog-details-left-sidebar.html">
                                            <img src="{{ asset('frontend/assets/images/blog/large-size/5.jpg')}}" alt="Uren's Blog Image">
                                        </a>
                            ...
                            <div class="slide-item">
                                <div class="inner-slide">
                                    <div class="blog-img img-hover_effect">
                                        <a href="blog-details-left-sidebar.html">
                                            <img src="{{ asset('frontend/assets/images/blog/large-size/6.jpg')}}" alt="Uren's Blog Image">
                                        </a>
                        ...
                        <div class="col-lg-4">
                            <div class="footer-widgets_info">
                                <div class="footer-widgets_logo">
                                    <a href="#">
                                        <img src="{{ asset('frontend/assets/images/menu/logo/1.png')}}" alt="Uren's Footer Logo">
                                    </a>
                                </div>
                    ...
                    <div class="footer-bottom_nav">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="payment">
                                    <a href="#">
                                        <img src="{{ asset('frontend/assets/images/footer/payment/1.png')}}" alt="Uren's Payment Method">
                                    </a>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="sp-img_area">
                                    ...
                                    "asNavFor": ".sp-img_slider-nav"
                                        ...
                                        <div class="single-slide red">
                                            <img src="{{ asset('frontend/assets/images/product/large-size/1.jpg')}}" alt="Uren's Product Image">
                                        </div>
                                        <div class="single-slide orange">
                                            <img src="{{ asset('frontend/assets/images/product/large-size/2.jpg')}}" alt="Uren's Product Image">
                                        </div>
                                        <div class="single-slide brown">
                                            <img src="{{ asset('frontend/assets/images/product/large-size/3.jpg')}}" alt="Uren's Product Image">
                                        </div>
                                        <div class="single-slide umber">
                                            <img src="{{ asset('frontend/assets/images/product/large-size/4.jpg')}}" alt="Uren's Product Image">
                                        </div>
                                        <div class="single-slide black">
                                            <img src="{{ asset('frontend/assets/images/product/large-size/5.jpg')}}" alt="Uren's Product Image">
                                        </div>
                                        <div class="single-slide golden">
                                            <img src="{{ asset('frontend/assets/images/product/large-size/6.jpg')}}" alt="Uren's Product Image">
                                        </div>
                                    </div>
                                   ...
                                   "spaceBetween": 30
                                    ...
                                    {"breakpoint":575, "settings": {"slidesToShow": 2}}
                                        ...
                                        <div class="single-slide red">
                                            <img src="{{ asset('frontend/assets/images/product/small-size/1.jpg')}}" alt="Uren's Product Thumnail">
                                        </div>
                                        <div class="single-slide orange">
                                            <img src="{{ asset('frontend/assets/images/product/small-size/2.jpg')}}" alt="Uren's Product Thumnail">
                                        </div>
                                        <div class="single-slide brown">
                                            <img src="{{ asset('frontend/assets/images/product/small-size/3.jpg')}}" alt="Uren's Product Thumnail">
                                        </div>
                                        <div class="single-slide umber">
                                            <img src="{{ asset('frontend/assets/images/product/small-size/4.jpg')}}" alt="Uren's Product Thumnail">
                                        </div>
                                        <div class="single-slide black">
                                            <img src="{{ asset('frontend/assets/images/product/small-size/5.jpg')}}" alt="Uren's Product Thumnail">
                                        </div>
                                        <div class="single-slide golden">
                                            <img src="{{ asset('frontend/assets/images/product/small-size/6.jpg')}}" alt="Uren's Product Thumnail">
                                        </div>
                                    </div>
                                </div>
                            </div>
